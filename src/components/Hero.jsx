      ...
      >
        ...
        <main className="relative z-10 flex items-center justify-center h-full px-4">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 max-w-6xl mx-auto">
            {/* Foto Profil */}
            <div className="w-48 h-48 md:w-[300px] md:h-[300px] rounded-full shadow-xl border-4 border-gray-200 flex items-center justify-center bg-white overflow-hidden">
              <motion.img
                src="/profil1.jpg"
                ...
                // Ukuran gambar lebih kecil dari wadah, tetap bulat & proporsional
              />
            </div>
